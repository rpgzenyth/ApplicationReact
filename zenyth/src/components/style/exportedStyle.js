/*
    ...
    1- Ajouter au export celui que vous avez créer dans un autre fichier
*/



export { StyleFooter, StyledHeader, HeaderImg, FooterDiv, TempFooter, ContentDiv } from "./layoutStyle"
export { Btn,BigBtn,BtnBlack,BtnWhite,ImgBigBtn,TempBtn, BtnLinkGame, ShareLink, BtnCopy } from "./buttonStyle"
